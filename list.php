...
if($category=='bachelor')
{
    ...
    $sql = "SELECT * FROM ".$datatable." WHERE c_name='".$course_name."' AND subject='".$subject_name."' AND type='".$category_type."' ORDER BY subject ASC LIMIT $start_from, ".$results_per_page;
}
...
<head>
    ...
    <title>NOTES 24X7 | Bachelor,Master,School,Entrance</title> <!--insert your title here-->
    <meta name="description" content="NOTES 24X7 | Bachelor,Master,School,Entrance"> <!--insert your description here-->
                    ...
                    <div class="nicdark_section nicdark_bg_greydark_alpha_gradient_2">
                        ...
                        <div class="nicdark_container nicdark_clearfix">
                            ...
                            <div class="grid grid_12">
                                <strong class="nicdark_color_white nicdark_font_size_60 nicdark_first_font"><?php echo $category_type;?></strong>
                            </div>
        ...
        <div class="nicdark_section nicdark_padding_15 nicdark_box_sizing_border_box">
            ...
            <div class="nicdark_section nicdark_border_1_solid_grey">
                ...
                <div class="nicdark_section nicdark_padding_20 nicdark_box_sizing_border_box">
                    ...
                    <div class="nicdark_section nicdark_height_50"></div>
                    <p><?php echo "( ".$value['subject']." , ".$value['type'].' )';?></p>
                            ...
                            <div class="nicdark_section nicdark_text_align_center pagination">
                                <?php
                                    ...
                                    if($page==1){}
                                        ...
                                        echo "<a href='list.php?page=".$previous."&amp;course_name=".$course_name."&amp;subject=".$subject_name."&amp;category_type=".$category_type."&amp;category=".$category."'>&laquo;</a>";
                                    }
                                    $sql = "SELECT COUNT(code_no) AS total FROM ".$datatable." WHERE c_name='".$course_name."' AND subject='".$subject_name."' AND type='".$category_type."'";
                                    $result = $conn->query($sql);
                                    $row = $result->fetch_assoc();
                                    $total_pages = ceil($row["total"] / $results_per_page); // calculate total pages with results

                                    for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                            echo "<a href='list.php?page=".$i."&amp;course_name=".$course_name."&amp;subject=".$subject_name."&amp;category_type=".$category_type."&amp;category=".$category."'";
                                            if ($i==$page)
                                            {
                                                echo " class='active'";
                                            }
                                    ...
                                    if($total_pages==$page || empty($c)){
                                        ...
                                        echo "<a href='list.php?page=".$next."&amp;course_name=".$course_name."&amp;subject=".$subject_name."&amp;category_type=".$category_type."&amp;category=".$category."' disabled>&raquo;</a>";
                                    }
                                    ?>
                            </div>
