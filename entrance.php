...
<head>
    ...
    <title>NOTES24X7 | Entrance</title> <!--insert your title here-->
    <meta name="description" content="NOTES24X7 | Entrance"> <!--insert your description here-->
    ...
    <body id="start_nicdark_framework">
        ...
        <div class="nicdark_site">
            ...
            ?>
                ...
                <div class="nicdark_section nicdark_background_size_cover nicdark_background_position_center" style="background-image:url(img/parallax/entrance.jpg);">
                    ...
                    <div class="nicdark_section nicdark_bg_greydark_alpha_gradient_2">
                        ...
                        <div class="nicdark_container nicdark_clearfix">
                            ...
                            <div class="grid grid_12">
                                <strong class="nicdark_color_white nicdark_font_size_60 nicdark_first_font">Entrance</strong>
                            </div>
                            ...
                            <div class="nicdark_section nicdark_padding_15 nicdark_box_sizing_border_box">
                                <div class="nicdark_section nicdark_box_sizing_border_box ">
                                    ...
                                    <div class="nicdark_width_100_percentage nicdark_float_left">
                                        <h2><strong>Showing 1 - 6 results</strong></h2>
                                    </div>
...
?>
    ...
    <!--START preview-->
    <a class="nicdark_color_greydark nicdark_first_font" href="subjects.php?category=entrance&amp;course_name=<?php echo $value['c_name']; ?>">
        ...
        <div class="nicdark_section nicdark_padding_15 nicdark_box_sizing_border_box">
            ...
            <div class="nicdark_section nicdark_border_1_solid_grey">
                ...
                <div class="nicdark_section nicdark_position_relative">
                    ...
                    <img alt="" class="nicdark_section" src="img/courses/img22.jpg">
                            ...
                            <div class="nicdark_section nicdark_text_align_center pagination">
                                <?php
                                    ...
                                    if($page==1){}
                                        ...
                                        echo "<a href='entrance.php?page=".$previous."'>&laquo;</a>";
                                    }
                                    ...
                                    for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                            echo "<a href='entrance.php?page=".$i."'";
                                            if ($i==$page)
                                            {
                                                echo " class='active'";
                                            }
                                    ...
                                    if($total_pages==$page || empty($c)){
                                        ...
                                        echo "<a href='entrance.php?page=".$next."' disabled>&raquo;</a>";
                                    }
                                    ?>
                            </div>
