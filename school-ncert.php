...
if($category=='school_ncert')
{
    $datatable ='s_ncert_materials';
    $sql = "SELECT * FROM ".$datatable." ORDER BY c_name ASC LIMIT $start_from, ".$results_per_page;
}
else
{
    header('location:index.php');
...
<head>
    ...
    <title>NOTES 24X7 | NCERT SOLUTIONS FOR ALL CLASSES CBSE</title> <!--insert your title here-->
    <meta name="description" content="NOTES 24X7 | NCERT SOLUTIONS FOR ALL CLASSES CBSE"> <!--insert your description here-->
                    ...
                    <div class="nicdark_section nicdark_bg_greydark_alpha_gradient_2">
                        ...
                        <div class="nicdark_container nicdark_clearfix">
                            ...
                            <div class="grid grid_12">
                                <strong class="nicdark_color_white nicdark_font_size_60 nicdark_first_font">NCERT SOLUTIONS</strong>
                            </div>
...
?>
    ...
    <!--START preview-->
    <a class="nicdark_color_greydark nicdark_first_font" href="data-course.php?code_no=<?php echo $value['code_no'];?>&amp;category=<?php echo 'ncert-school';?>">
    <!--START preview-->
                            ...
                            <div class="nicdark_section nicdark_text_align_center pagination">
                                <?php
                                    ...
                                    if($page==1){}
                                        ...
                                        echo "<a href='schoolncert.php?page=".$previous."&amp;category=".$category."'>&laquo;</a>";
                                    }
                                    ...
                                    for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                            echo "<a href='school-ncert.php?page=".$i."&amp;category=".$category."'";
                                            if ($i==$page)
                                            {
                                                echo " class='active'";
                                            }
                                    ...
                                    if($total_pages==$page || empty($c)){
                                        ...
                                        echo "<a href='school-ncert.php?page=".$next."&amp;category=".$category."' disabled>&raquo;</a>";
                                    }
                                    ?>
                            </div>
