...
if(isset($_GET['category']) AND isset($_GET['code_no']))
{
...
if($category=='Posts')
{
    ...
    $sql_1 = "SELECT * FROM ".$datatable." WHERE code_no!='".$code_no."' ORDER BY RAND() LIMIT 6";
}
...
<head>
    ...
    <title><?php echo $row['title'];?> | NOTES24x7</title> <!--insert your title here-->
                        ...
                        <div class="nicdark_container nicdark_clearfix">
                            ...
                            <div class="nicdark_width_66_percentage nicdark_width_100_percentage_ipad_port nicdark_width_100_percentage_all_iphone nicdark_float_left">
                                ...
                                <div class="nicdark_section nicdark_padding_15 nicdark_box_sizing_border_box">
                                    ...
                                    <h1><strong class="nicdark_font_size_30 nicdark_first_font"><?php echo $row['title'];?></strong></h1>
                                    ...
                                    <h3 class="nicdark_display_table_cell nicdark_vertical_align_middle"><?php echo $row['date_upload'];?></h3>
                                </div>
                                        ...
                                        <div class="nicdark_tabs">
                                            ...
                                            <div class="nicdark_section" id="tabs-1">
                                                ...
                                                <div class="nicdark_section nicdark_height_140">
                                                    ...
                                                    href="/parts/files/Posts/<?php echo $row['uploaded_files']; ?>" download>DOWNLOAD NOW</a>
                                                    <div class="nicdark_section nicdark_height_20"></div>
                                                ...
                                                <div class="nicdark_section">
                                                    ...
                                                    <script>PDFObject.embed("/parts/files/Posts/<?php echo $row['uploaded_files'];?>", "#example1");</script>
                                                ...
                                                <!--PDF VIEWER-->
                                                <div class="nicdark_section">
                                                    <iframe style="width:100%;height:600px" sandbox="allow-same-origin allow-scripts allow-popups allow-forms" src="<?php echo $row['link'];?>">
                                                        <p>iFrame Not Supported By This Browser.</p>
                                                    </iframe>
                                                </div>
                                                <?php
                                                }
...
?>
 <a class="nicdark_color_greydark nicdark_first_font" href="post-result-data.php?code_no=<?php echo $value['code_no'];?>&amp;category=<?php echo $category;?>">
    <!--START preview-->
    <div class="nicdark_width_33_percentage nicdark_width_100_percentage_ipad_port nicdark_width_100_percentage_all_iphone nicdark_float_left" >
        ...
        <div class="nicdark_section nicdark_padding_15 nicdark_box_sizing_border_box" >
            ...
            <div class="nicdark_section nicdark_border_1_solid_grey" id="related-article">
                ...
                <div class="nicdark_section nicdark_padding_20 nicdark_box_sizing_border_box">
                    ...
                    <div class="nicdark_section nicdark_height_50"></div>
                    <h5><?php echo $value['date_upload']; ?></h5>
