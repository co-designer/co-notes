...
if(isset($_GET['category'])){ $category=$_GET['category']; } else{ header("location:index.php"); }


if(isset($_GET["course_name"])){ $course_name=$_GET["course_name"]; } else{ header("location:index.php"); }
...
if($category=='school'){ $datatable='s_subjects'; } else{ $datatable='b_m_subjects'; }

$sql = "SELECT subjects FROM ".$datatable." WHERE c_name='".$course_name."'";

$rs_result = $conn->query($sql);

$row = $rs_result->fetch_assoc();

$c = explode("//",$row['subjects']);
    ...
    <body id="start_nicdark_framework">
        ...
        <div class="nicdark_site">
            ...
            ?>
                ...
                <div class="nicdark_section nicdark_background_size_cover nicdark_background_position_center" style="background-image:url(img/courses/subject.jpg);">
                    ...
                    <div class="nicdark_section nicdark_bg_greydark_alpha_gradient_2">
                        ...
                        <div class="nicdark_container nicdark_clearfix">
                            ...
                            <div class="grid grid_12">
                                <strong class="nicdark_color_white nicdark_font_size_60 nicdark_first_font">Subjects</strong>
                            </div>
                            ...
                            <div class="nicdark_section nicdark_padding_15 nicdark_box_sizing_border_box">
                                <div class="nicdark_section nicdark_box_sizing_border_box ">
                                    ...
                                    <div class="nicdark_width_100_percentage nicdark_float_left">
                                        <h2><strong>Showing 1 - 12 results</strong></h2>
                                    </div>
...
?>
    ...
    <!--START preview-->
    <a class="nicdark_color_greydark nicdark_first_font" href="content-category.php?category=<?php echo $category; ?>&amp;course_name=<?php echo $course_name; ?>&amp;subject_name=<?php echo $c[$i]; ?>">
                            ...
                            <div class="nicdark_section nicdark_text_align_center pagination">
                                <?php
                                    ...
                                    if($page==1){}
                                        ...
                                        echo "<a href='subjects.php?page=".$previous."&amp;category=".$category."&amp;course_name=".$course_name."'>&laquo;</a>";
                                    }

                                    for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                            echo "<a href='subjects.php?page=".$i."&amp;category=".$category."&amp;course_name=".$course_name."'";
                                            if ($i==$page)
                                            {
                                                echo " class='active'";
                                            }
                                    ...
                                    if($total_pages==$page || empty($c)){
                                        ...
                                        echo "<a href='subjects.php?page=".$next."&amp;category=".$category."&amp;course_name=".$course_name."' disabled>&raquo;</a>";
                                    }
                                    ?>
                            </div>
