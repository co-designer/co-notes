            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ADD SCHOOL STUDY MATERIALS
                            </h2>
                        </div>
                        <form id="add_material_school" name="add_material_school">
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <select class="form-control show-tick" id="category_name_chapter" name="category_name_chapter" data-live-search="true" >
                                ...
                                <div class="col-md-4">
                                    <select class="form-control show-tick" id="course_name_chapter" name="course_name_chapter" data-live-search="true" disabled>
                                        <option selected disabled>Course</option>
                                    </select>
                                </div>

                                <div class="col-md-4">
                                    <select class="form-control show-tick" id="subject_name_chapter" name="subject_name_chapter" data-live-search="true" disabled>
                                ...
                                <div class="col-md-6" id="chapters-div" style="display: none;">
                                    <div class="input-group">
                                            <select class="form-control show-tick" id="chapters" name="chapters" data-live-search="true">
                                                <option selected disabled>Chapters</option>
                                            </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-12">
                                    <div class="input-group">
                                        <div class="form-line">
                                            <textarea rows="8" class="form-control no-resize" id="description" name="description" placeholder="Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <div class="form-line">
                                        <div class="upload">
                                            <input type="file" name="files" data-fileuploader-limit="1" accept=".pdf" id="upload_files">
                                ...
                                <div class="col-md-3">  
                                    <div>
                                    	<button type="button" class="btn btn-primary m-t-15 waves-effect" name="add_school_material" id="add_school_material" disabled>Submit</button>
                                    </div>
                                </div>
                            </div>
                            </div>
