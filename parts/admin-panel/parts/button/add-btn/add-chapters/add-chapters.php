            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form id="course_add_chapter" name="course_add_chapter">
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Subject Name" id="chapter_name" name="chapter_name" style="text-transform:capitalize;" disabled>
                                        </div>
                                        <small id="check"></small>
                                    </div>
                                    <div id="val"></div>
                                    <div>
                                    	<button type="button" class="btn btn-primary m-t-15 waves-effect" name="add_chapter" id="add_chapter" disabled>Submit</button>
                                    </div>
                                </div>
                            </div>
                            </div>
