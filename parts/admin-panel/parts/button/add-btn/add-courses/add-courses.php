            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form id="course_add" name="course_add">
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Course Name" id="c_name" name="c_name" style="text-transform:uppercase;" disabled>
                                        </div>
                                        <small id="check"></small>
                                    </div>
                                    <div>
                                    	<button type="button" class="btn btn-primary m-t-15 waves-effect" name="add_course" id="add_course" disabled>Submit</button>
                                    </div>
                                </div>
                            </div>
                            </div>
