            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ADD COLLEGE STUDY MATERIALS
                            </h2>
                        </div>
                        <form id="add_material_college" name="add_material_college">
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                            <select class="form-control show-tick" id="type_bachelor" name="type" data-live-search="true">
                                ...
                                <div class="col-md-3">  
                                    <div>
                                    	<button type="button" class="btn btn-primary m-t-15 waves-effect" name="add_college_material" id="add_college_material" disabled>Submit</button>
                                    </div>
                                </div>
                            </div>
                            </div>
