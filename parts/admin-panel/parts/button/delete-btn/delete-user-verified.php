<?php
    ...
    $stmt  = $mysqli->prepare('SELECT email,mobile,type FROM login');
    $stmt->execute();
...
?>        
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="bootstrap-table">
                ...
                <tr>
                    ...
                    <th width="20%">Last Login Date</th>
                ...
                <tr>
                        ...
                        if($key=="email"){
                            ...
                            <td>
                                <?php 
                                    echo $value1; 
                                ?>
                                <input type="hidden" name="userid" id="userid-<?php echo $i;?>" value="<?php echo $value1;?>">
                            </td>
                    <?php
                    ...
                    <td>
                       <button type="button" class="btn btn-danger waves-effect" id="btnDialog" value="<?php echo $i;?>">
