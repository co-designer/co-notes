...
<head>
    ...
    <title>NOTES24X7 | <?php echo $type; ?> Subjects</title> <!--insert your title here-->
    <meta name="description" content="NOTES24X7 - <?php echo $type; ?> Subjects"> <!--insert your description here-->
    ...
    <body id="start_nicdark_framework">
        ...
        <div class="nicdark_site">
            ...
            ?>
                ...
                <div class="nicdark_section nicdark_background_size_cover nicdark_background_position_center" style="background-image:url(img/parallax/img24.jpg);">
                    ...
                    <div class="nicdark_section nicdark_bg_greydark_alpha_gradient_2">
                        ...
                        <div class="nicdark_container nicdark_clearfix">
                            ...
                            <div class="grid grid_12">
                                <strong class="nicdark_color_white nicdark_font_size_60 nicdark_first_font">Master</strong>
                            </div>
...
?>
    ...
    <!--START preview-->
    <a class="nicdark_color_greydark nicdark_first_font" href="subjects.php?category=master&amp;course_name=<?php echo $value['c_name']; ?>">
                            ...
                            <div class="nicdark_section nicdark_text_align_center pagination">
                                <?php
                                    ...
                                    if($page==1){}
                                        ...
                                        echo "<a href='master.php?page=".$previous."'>&laquo;</a>";
                                    }
                                    ...
                                    if($total_pages==$page || empty($c)){
                                        ...
                                        echo "<a href='master.php?page=".$next."' disabled>&raquo;</a>";
                                    }
                                    ?>
                            </div>
