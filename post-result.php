...
{
    $datatable ='post_24x7';
    $sql = "SELECT * FROM ".$datatable." ORDER BY date_upload DESC LIMIT $start_from, ".$results_per_page;
}
...
<head>
    ...
    <title>NOTES 24X7 | POSTS,RESULTS,Bachelor,Master,School,Entrance</title> <!--insert your title here-->
    <meta name="description" content="NOTES 24X7 | Posts,Results,Bachelor,Master,School,Entrance"> <!--insert your description here-->
                    ...
                    <div class="nicdark_section nicdark_bg_greydark_alpha_gradient_2">
                        ...
                        <div class="nicdark_container nicdark_clearfix">
                            ...
                            <div class="grid grid_12">
                                <strong class="nicdark_color_white nicdark_font_size_60 nicdark_first_font"><?php echo $category;?></strong>
                            </div>
        ...
        <div class="nicdark_section nicdark_padding_15 nicdark_box_sizing_border_box">
            ...
            <div class="nicdark_section nicdark_border_1_solid_grey">
                ...
                <div class="nicdark_section nicdark_padding_20 nicdark_box_sizing_border_box">
                    ...
                    <p><?php echo $value['date_upload'];?></p>
                            ...
                            <div class="nicdark_section nicdark_text_align_center pagination">
                                <?php
                                    ...
                                    if($page==1){}
                                        ...
                                        echo "<a href='post-result.php?page=".$previous."&amp;category=".$category."'>&laquo;</a>";
                                    }
                                    $sql = "SELECT COUNT(code_no) AS total FROM ".$datatable;
                                    $result = $conn->query($sql);
                                    $row = $result->fetch_assoc();
                                    $total_pages = ceil($row["total"] / $results_per_page); // calculate total pages with results

                                    for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                                            echo "<a href='post-result.php?page=".$i."&amp;category=".$category."'";
                                            if ($i==$page)
                                            {
                                                echo " class='active'";
                                            }
                                    ...
                                    if($total_pages==$page || empty($c)){
                                        ...
                                        echo "<a href='post-result.php?page=".$next."&amp;category=".$category."' disabled>&raquo;</a>";
                                    }
                                    ?>
                            </div>
