...
<head>
    ...
    <title>NOTES24X7 | </title> <!--insert your title here-->
    <meta name="description" content="NOTES24X7 - "> <!--insert your description here-->
...
?>
    ...
    <!--START preview-->
    <a class="nicdark_color_greydark nicdark_first_font" href="subjects.php?category=school&amp;course_name=<?php echo $value['c_name']; ?>" >
                            ...
                            <div class="nicdark_section nicdark_text_align_center pagination">
                                <?php
                                    ...
                                    if($page==1){}
                                        ...
                                        echo "<a href='school.php?page=".$previous."'>&laquo;</a>";
                                    }
                                    ...
                                    if($total_pages==$page || empty($c)){
                                        ...
                                        echo "<a href='school.php?page=".$next."' disabled>&raquo;</a>";
                                    }
                                    ?>
                            </div>
